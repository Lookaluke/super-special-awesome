...
public class Window extends JComponent{
   ...
   public Window(JFrame frame){
       ...
       //txt = new TextBox(frame,"Hello welcome to pokemon razmatazz. How are you doing today? I am fine thanks for asking. My name is Mark, I'm the only person working on this project, besides Hurshal who is doing an outstanding job keeping up with the insane workload",0,475,800,101);
